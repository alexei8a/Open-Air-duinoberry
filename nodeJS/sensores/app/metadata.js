...
function selectMetadata(sensorName){
	...
	case "GPS Neo-6M":
	case "gps neo-6m":
		var	metadata={"field":"ubicación (latitud-longitud)", "unit":"m",  "accuracy":"2.5m", "principle":"Comunicación satelital","canales":"50", "update frequency":"5Hz", "interfaces":"UART, USB, SPI", "dynamics":"si", "supplyVoltage":"3.3V"};
		break;
